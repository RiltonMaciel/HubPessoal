...
const links = [
  { section: "Analytics", items: [{ href: "/import", label: "📥 Importar" }, { href: "/dashboard", label: "📊 Dashboard" }, { href: "/aovivo", label: "🟢 AoVivo" }, { href: "/h2h", label: "🤝 Confronto" }, { href: "/auditoria", label: "📈 Auditoria" }, { href: "/analise-jogos", label: "🧠 Análise Jogos" }, { href: "/betsapi", label: "🕸️ BetsAPI" }, { href: "/transmissao", label: "📺 Transmissão" }, { href: "/player/MJ", label: "👤 Player" }] },
