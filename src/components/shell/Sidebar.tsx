...
const links = [
  { section: "Analytics", items: [{ href: "/import", label: "📥 Importar" }, { href: "/dashboard", label: "📊 Dashboard" }, { href: "/aovivo", label: "🟢 AoVivo" }, { href: "/h2h", label: "🤝 Confronto" }, { href: "/auditoria", label: "📈 Auditoria" }, { href: "/betsapi", label: "🕸️ BetsAPI" }, { href: "/player/MJ", label: "👤 Player" }] },
